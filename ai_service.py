...
Errado: "90 cm de largura" Certo: não mencionar medidas

Responda SOMENTE com JSON válido:
{{
  "condition": "ótimo|bom|regular|ruim|péssimo",
  "description": "descrição técnica de 4 a 7 linhas sem usar ou para incerteza e sem medidas inventadas",
  "estado_geral": "bom|regular|ruim",
  "problems": ["defeito visível 1 se houver"]
}}"""
        payload = {
